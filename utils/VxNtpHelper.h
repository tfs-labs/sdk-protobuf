...
#define NTP_PORT   123  ///< NTP   NTP private port number
...
{ 
    x_uint32_t  xut_seconds;    ///<   1900  The number of seconds elapsed from 1900 to the present
    x_uint32_t  xut_fraction;   ///<  ， 4294.967296( = 2^32 / 10^6 )  The decimal part is a factor of 4294.967296 ( = 2^32 / 10^6 ) of the number of microseconds
} x_ntp_timestamp_t;

/**
 * @struct x_ntp_timeval_t
 * @brief    timeval  。 Redefine the timeval struct of the system.
 */
